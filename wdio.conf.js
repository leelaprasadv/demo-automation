...
exports.config = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            args: ['user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.54 Safari/537.36',
    ...
    services: process.env.SELENIUM_HOST ? [] : ['chromedriver'],
    ...
    onPrepare: function (config, capabilities) {
        ...
        dotenv.config();
        config["email_config"] = require('./config').READ_MAIL_CONFIG;
    },
    /**
